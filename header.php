            ...
            <div class="col-lg-8 col-lg-push-2 text-center">
                ...
                <?php
                    if ($_GET) {
                        ...
                        <?php } else if ($_GET['connected'] == 4) { //MDP VIDE ?>
                            <p class="error-message"> Vos identifiants ne sont pas reconnus. <br> Merci de réessayer ou
                                de créer un nouveau compte </p>
                        <?php }
                    } ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12" id="sign-up-div">
                        <form class="form-inline" role="form" method="POST" action="bdd/users/create.php"
                            ...
                            <div class="row">
                                <div class="col-md-12 form-field">
                                    <div class="form-group"><input name="nickname" type="text"
                                                                   class="form-control input-lg"
                                                                   id="nicknameRegister"
                                                                   placeholder="Ton pseudo"></div>
                                    <div class="form-group"><input name="email" type="email"
                                                                   class="form-control input-lg"
                                                                   id="emailRegister"
                                                                   placeholder="Ton email"></div>
                                </div>
                                <div class="col-md-12 form-field">
                                    <div class="form-group"><input name="password" type="password"
                                                                   class="form-control input-lg"
                                                                   id="passwordRegister"
                                                                   placeholder="Ton mot de passe">
                                    </div>
                                    <div class="form-group"><input name="confirmPassword" type="password"
                                                                   class="form-control input-lg"
